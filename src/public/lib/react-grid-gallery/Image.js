...
var _ViewButton = require('./ViewButton.js')
...
var Image = function (_Component) {
    ...
    _createClass(Image, [{
        ...
        value: function renderViewButton() {
            return _react2.default.createElement(_ViewButton2.default, { key: 'SelectView',
                index: this.props.index,
                color: "rgba(255, 255, 255, 0.7)",
                selectedColor: "#f42114",
                hoverColor: "rgba(255, 255, 255, 1)",
                isFirst: this.props.item.isFirst,
                isSelectable: this.props.isSelectable,
                onClick: this.props.isSelectable ? this.props.onSelectFirstImage : null,
                parentHover: this.state.hover });
        }
    },{
        key: 'render',
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement('div', { className: 'tile-overlay',
                    ...
                    style: {
                        ...
                        height: "100%",
                        width: "100%",
                        background: this.state.hover && !this.props.item.isSelected && this.props.isSelectable && this.props.item.isFirst? 'linear-gradient(to bottom,rgba(0,0,0,0.26),transparent 56px,transparent)' : 'none' } }),
                _react2.default.createElement(
                    'div',
...
Image.propTypes = {
    ...
    onSelectFirstImage: _propTypes2.default.func,
