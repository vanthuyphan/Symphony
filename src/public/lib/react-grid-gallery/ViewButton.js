...
var ViewButton = function (_Component) {
    _inherits(ViewButton, _Component);

    function ViewButton(props) {
        _classCallCheck(this, ViewButton);

        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ViewButton).call(this, props));
    ...
    _createClass(ViewButton, [{
        key: 'fill',
        value: function fill() {
            if (this.props.isFirst) return this.props.selectedColor;else if (this.state.hover) return this.props.hoverColor;
            return this.props.color;
        }
    }, {
        key: 'visibility',
        value: function visibility() {
            if (this.props.isFirst || this.props.isSelectable && this.props.parentHover) return 'visible';
            return 'hidden';
        }
    }, {
        key: 'render',
        value: function render() {
            ...
            var circleStyle = {
                display: this.props.isFirst ? "block" : "none"
            };
...
ViewButton.propTypes = { index: _propTypes2.default.number,
...
ViewButton.defaultProps = { isSelectable: true,
    isFirst: false,
    parentHover: false,
    hover: false };
