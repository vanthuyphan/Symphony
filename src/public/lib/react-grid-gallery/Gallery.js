...
var Gallery = function (_Component) {
    ...
    function Gallery(props) {
        ...
        _this.onSelectFirstImage = _this.onSelectFirstImage.bind(_this);
        return _this;
    }
    ...
    _createClass(Gallery, [{
        ...
        key: 'onSelectFirstImage',
        value: function onSelectFirstImage(index, event) {
            event.preventDefault();
            if (this.props.onSelectFirstImage) this.props.onSelectFirstImage.call(this, index, this.state.images[index]);
        }
    },  {
        key: 'gotoImage',
        ...
        value: function render() {
            ...
            var images = this.state.thumbnails.map(function (item, idx) {
                return _react2.default.createElement(_Image2.default, {
                    ...
                    onSelectFirstImage:_this2.onSelectFirstImage,
